...
import '../../widgets/Minima/history_list.dart';
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          // Radial Mesh 4: Brilliant Golden Backlight
          Positioned(
          ...
          // Custom Painted Hyperlink Web Overlay
          Positioned.fill(
            child: CustomPaint(
              painter: WebPainter(),
            ),
          ...
          MouseRegion(
            ...
            child: GestureDetector(
              ...
              child: Row(
                ...
                children: [
                  const Icon(Icons.arrow_back_ios, color: Color(0xFFC5A059), size: 14),
