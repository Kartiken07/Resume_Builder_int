...
import '../../notifiers/Minima/link_notifier.dart';
import '../../notifiers/Minima/history_notifier.dart';
import '../../models/Minima/link_model.dart';
import '../../api_services/Minima/share_helper.dart';
            ...
            children: [
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  prefixIcon: const Icon(Icons.link, color: Color(0xFFC5A059)),
                  labelStyle: const TextStyle(color: Color(0xFFC5A059), fontSize: 14, fontWeight: FontWeight.w600),
                  filled: true,
                  ...
                  Expanded(
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintStyle: TextStyle(color: Colors.black.withOpacity(0.3), fontSize: 14),
                        prefixIcon: const Icon(Icons.alternate_email, color: Color(0xFFC5A059)),
                        labelStyle: const TextStyle(color: Color(0xFFC5A059), fontSize: 14, fontWeight: FontWeight.w600),
                        filled: true,
                        fillColor: Colors.white,
                        enabledBorder: OutlineInputBorder(
                        ...
                        gradient: _selectedDate != null 
                          ? LinearGradient(
                              colors: [
                                ...
                                const Color(0xFF8C6D31).withOpacity(0.15),
                              ],
                            )
                          : null,
                        color: _selectedDate == null ? Colors.white.withOpacity(0.05) : null,
                        borderRadius: BorderRadius.circular(16),
                        border: Border.all(
