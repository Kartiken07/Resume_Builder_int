...
class EmiValueCard extends StatelessWidget {
  const EmiValueCard({required this.title, required this.value, super.key});
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(value, style: AppTheme.cardValueLarge),
        ],
      ),
    );
  }
